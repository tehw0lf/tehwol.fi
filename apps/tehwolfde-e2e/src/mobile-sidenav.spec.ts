...
test.describe('Mobile Sidenav Behavior', () => {
  ...
  test('should show mobile sidenav component on small screens', async ({
    page
  }) => {
  ...
  test('should close sidenav when clicking navigation links', async ({
    page
  }) => {
  ...
  test('should close sidenav when clicking outside (focus loss)', async ({
    page
  }) => {
    // Open sidenav
    const menuButton = page.locator('tehw0lf-desktop button#menu');
    ...
    await mainContent.click({ position: { x: 350, y: 555 } });
  ...
  test('should close sidenav when clicking Wordlist Generator link', async ({
    page
  }) => {
    // Open sidenav
    const menuButton = page.locator('tehw0lf-desktop button#menu');
  ...
  test('should close sidenav when clicking Contact Form link', async ({
    page
  }) => {
    // Open sidenav
    const menuButton = page.locator('tehw0lf-desktop button#menu');
  ...
  test('should handle GitHub external link without closing sidenav prematurely', async ({
    page
  }) => {
    // Open sidenav
    const menuButton = page.locator('tehw0lf-desktop button#menu');
  ...
  test('should toggle sidenav when clicking menu button multiple times', async ({
    page
  }) => {
  ...
  test('should maintain theme switching functionality in mobile sidenav', async ({
    page
  }) => {
    // Open sidenav
    const menuButton = page.locator('tehw0lf-desktop button#menu');
  ...
  test('should handle rapid clicks on menu button gracefully', async ({
    page
  }) => {
    const menuButtonToolbar = page.locator('tehw0lf-desktop button#menu');
    const sidenav = page.locator('mat-sidenav');
