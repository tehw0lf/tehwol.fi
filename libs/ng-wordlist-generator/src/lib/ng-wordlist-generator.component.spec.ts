...
describe('NgWordlistGeneratorComponent', () => {
  let component: NgWordlistGeneratorComponent;
  let fixture: ComponentFixture<NgWordlistGeneratorComponent>;
  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        ...
        providers: [
          {
            provide: NgWordlistGeneratorService,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(NgWordlistGeneratorComponent);
